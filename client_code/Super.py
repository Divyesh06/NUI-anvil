...
from .SuperComponentTemplate import SuperComponentTemplate

class Super(SuperComponentTemplate):
    container = False

    def init(self, form, **properties):
        css_manager.create_stylesheet(form)
        ...
        form.init_components(**properties)
